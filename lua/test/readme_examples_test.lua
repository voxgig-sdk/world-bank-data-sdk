...
local SDK_MODULE = "world-bank-data_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["country"] = { ["test01"] = { id = "test01" } }, ["indicator"] = { ["test01"] = { id = "test01" } }, ["metadata"] = { ["test01"] = { id = "test01" } }, ["topic"] = { ["test01"] = { id = "test01" } } } }'
