...
function runner.env_override(m)
  local live = runner.getenv("WORLDBANKDATA_TEST_LIVE")
  local override = runner.getenv("WORLDBANKDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WORLDBANKDATA_TEST_EXPLAIN")
