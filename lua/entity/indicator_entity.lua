-- WorldBankData SDK Indicator entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local IndicatorEntity = {}
IndicatorEntity.__index = IndicatorEntity


function IndicatorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IndicatorEntity)
...
function IndicatorEntity:get_name()
  return self._name
end


function IndicatorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IndicatorEntity.new(self._client, opts)
end
...
function IndicatorEntity:mark_deleted()
  self._deleted = true
end


function IndicatorEntity:deleted()
  return true == self._deleted
end


function IndicatorEntity:data_set(args)
  if args ~= nil then
...
function IndicatorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IndicatorEntity:match_set(args)
  if args ~= nil then
...
function IndicatorEntity:match_get()
...
function IndicatorEntity:stream(action, args, callopts)
...
---@param reqmatch IndicatorLoadMatch
---@param ctrl? table
---@return Indicator
---@return string? err
function IndicatorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch IndicatorListMatch
---@param ctrl? table
---@return Indicator[]
---@return string? err
function IndicatorEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function IndicatorEntity:_run_op(ctx, post_done)
  local utility = self._utility
