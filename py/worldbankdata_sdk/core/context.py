...
from worldbankdata_sdk.core.helpers import get_ctx_prop, to_map
...
class WorldBankDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WorldBankDataControl()
        ...
        if isinstance(sp, WorldBankDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WorldBankDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WorldBankDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WorldBankDataError(code, msg, self)
