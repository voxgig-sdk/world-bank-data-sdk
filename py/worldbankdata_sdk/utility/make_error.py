...
def make_error_util(ctx, err):
    if ctx is None:
        from worldbankdata_sdk.core.context import WorldBankDataContext
        ctx = WorldBankDataContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, WorldBankDataError):
        errmsg = err.msg
    ...
    sdk_err = WorldBankDataError("", msg, ctx)
