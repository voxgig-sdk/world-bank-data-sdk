...
from worldbankdata_sdk.utility import register

# Load features
from worldbankdata_sdk.feature.base_feature import WorldBankDataBaseFeature
from worldbankdata_sdk.features import _has_feature, _make_feature
...
class WorldBankDataSDK:
    ...
    def get_utility(self):
        return WorldBankDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WorldBankDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Country(self, data=None) -> "CountryEntity":
        ...
        from worldbankdata_sdk.entity.country_entity import CountryEntity
    ...
    def Indicator(self, data=None) -> "IndicatorEntity":
        ...
        from worldbankdata_sdk.entity.indicator_entity import IndicatorEntity
    ...
    def Metadata(self, data=None) -> "MetadataEntity":
        ...
        from worldbankdata_sdk.entity.metadata_entity import MetadataEntity
        return MetadataEntity(self, data)


    def Topic(self, data=None) -> "TopicEntity":
        """Entity factory: client.Topic().list() / client.Topic().load({"id": ...})."""
        from worldbankdata_sdk.entity.topic_entity import TopicEntity
