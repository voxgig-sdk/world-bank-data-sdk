# WorldBankData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WorldBankDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WorldBankDataSDK(...) and WorldBankDataSDK.test(...) become
#      WorldBankDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "worldbankdata_sdk"
_SDK_CLASS = "WorldBankDataSDK"
