...
class WorldBankDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldBankDataTestRunner.getenv("WORLDBANKDATA_TEST_LIVE")
        override = WorldBankDataTestRunner.getenv("WORLDBANKDATA_TEST_OVERRIDE")
        ...
        explain = WorldBankDataTestRunner.getenv("WORLDBANKDATA_TEST_EXPLAIN")
