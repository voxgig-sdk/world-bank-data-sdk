...
class MetadataEntity
  ...
  def make
    opts = @_entopts.dup
    MetadataEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [MetadataListMatch, Hash, nil] match filter (any subset of
  #   Metadata fields); defaults to nil, treated as an empty match that lists all.
