...
class TopicEntity
  ...
  #
  # @param reqmatch [TopicListMatch, Hash, nil] match filter (any subset of
  #   Topic fields); defaults to nil, treated as an empty match that lists all.
