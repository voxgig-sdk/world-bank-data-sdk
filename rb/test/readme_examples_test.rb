...
#      offline in seeded test mode (WorldBankDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WorldBankData_sdk.rb")
  SDK_CLASS = "WorldBankDataSDK"
