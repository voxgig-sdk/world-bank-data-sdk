...
class TopicEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WORLDBANKDATA_TEST_TOPIC_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def topic_basic_setup(extra)
  ...
  entid_env_raw = ENV["WORLDBANKDATA_TEST_TOPIC_ENTID"]
