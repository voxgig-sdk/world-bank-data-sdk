...
func registerSDKWords(r *eng.Registry, client *sdk.WorldBankDataSDK) {
...
func runOp(client *sdk.WorldBankDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
