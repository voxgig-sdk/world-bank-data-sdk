...
boru-driven command-line client **and** interactive REPL for the WorldBankData
...
- `<entity>` is a bareword, auto-quoted as an boru atom (e.g. `country`).
