...
func TestTopicEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set WORLDBANKDATA_TEST_TOPIC_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func topicBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("WORLDBANKDATA_TEST_TOPIC_ENTID")
