...
const testSeed = `map[string]any{"entity": map[string]any{"country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "indicator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "metadata": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "topic": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
