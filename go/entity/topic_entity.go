...
func NewTopicEntity(client *core.WorldBankDataSDK, entopts map[string]any) *TopicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TopicEntity) GetName() string { return e.name }
...
func (e *TopicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TopicEntity) Deleted() bool {
	return e.deleted
}


func (e *TopicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTopicEntity(e.client, opts)
}

func (e *TopicEntity) Data(args ...any) any {
...
func (e *TopicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Topic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TopicEntity) DataTyped(data ...Topic) Topic {
	if len(data) > 0 {
		return typedFrom[Topic](e.Data(asMap(data[0])))
	}
	return typedFrom[Topic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Topic (all fields
// optional at the wire level).
func (e *TopicEntity) MatchTyped(match ...Topic) Topic {
	if len(match) > 0 {
		return typedFrom[Topic](e.Match(asMap(match[0])))
	}
	return typedFrom[Topic](e.Match())
}
...
func (e *TopicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TopicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TopicEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TopicListMatch and returns []Topic. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TopicEntity) ListTyped(reqmatch TopicListMatch, ctrl map[string]any) ([]Topic, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Topic](res), nil
}



func (e *TopicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TopicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TopicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TopicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
