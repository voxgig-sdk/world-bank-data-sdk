...
func NewMetadataEntity(client *core.WorldBankDataSDK, entopts map[string]any) *MetadataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MetadataEntity) Deleted() bool {
	return e.deleted
}


func (e *MetadataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMetadataEntity(e.client, opts)
}

func (e *MetadataEntity) Data(args ...any) any {
...
func (e *MetadataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *MetadataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MetadataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *MetadataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MetadataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MetadataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
