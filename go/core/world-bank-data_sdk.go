...
func (sdk *WorldBankDataSDK) OptionsMap() map[string]any {
...
func (sdk *WorldBankDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WorldBankDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WorldBankDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldBankDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WorldBankDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WorldBankDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WorldBankDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WorldBankDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldBankDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WorldBankDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WorldBankDataSDK {
	...
	sdk := NewWorldBankDataSDK(sdkopts)
	sdk.Mode = "test"
