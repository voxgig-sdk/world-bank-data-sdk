...
// WorldBankData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WorldBankDataSDK::test)
...
{
    private const SDK_CLASS = 'WorldBankDataSDK';
    ...
    private const SDK_BASE = 'worldbankdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../worldbankdata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
