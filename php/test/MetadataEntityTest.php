...
class MetadataEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WORLDBANKDATA_TEST_METADATA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function metadata_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WORLDBANKDATA_TEST_METADATA_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["WORLDBANKDATA_TEST_METADATA_ENTID"]);
