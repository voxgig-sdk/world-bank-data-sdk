...
// WorldBankData SDK pipeline test
//
...
{
    private static function utility(): WorldBankDataUtility
    {
        return new WorldBankDataUtility();
    }
    ...
    private static function ctx(array $over = []): WorldBankDataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WorldBankDataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WorldBankDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WorldBankDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WorldBankDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WorldBankDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WorldBankDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WorldBankDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WorldBankDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WorldBankDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WorldBankDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WorldBankDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WorldBankDataResponse([]),
            'result' => new WorldBankDataResult([]),
        ]);
        [, $err] = WorldBankDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WorldBankDataSpec([]),
            'response' => null,
            'result' => new WorldBankDataResult([]),
        ]);
        [, $err] = WorldBankDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WorldBankDataSpec(['step' => 's']),
            'response' => new WorldBankDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WorldBankDataResult([]),
        ]);
        [, $err] = WorldBankDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WorldBankDataSpec(['step' => 's']),
            'response' => new WorldBankDataResponse(self::resp(200, ['v' => 1])),
            'result' => new WorldBankDataResult([]),
        ]);
        [, $err] = WorldBankDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WorldBankDataSpec(['step' => 's']),
            'response' => new WorldBankDataResponse(self::resp(200, ['v' => 2])),
            'result' => new WorldBankDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WorldBankDataMakeResponse::call($ctx);
    ...
    {
        $preset = new WorldBankDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WorldBankDataSpec([]),
            'response' => new WorldBankDataResponse([]),
            'result' => new WorldBankDataResult([]),
        ...
        [$got, $err] = WorldBankDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WorldBankDataResult([])]);
        [, $err] = WorldBankDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WorldBankDataSpec([]), 'result' => null]);
        [, $err] = WorldBankDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WorldBankDataSpec(['step' => 's']),
            'result' => new WorldBankDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WorldBankDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WorldBankDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WorldBankDataSpec(['step' => 's']),
            'result' => new WorldBankDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WorldBankDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WorldBankDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WorldBankDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WorldBankDataSpec([]),
            'result' => new WorldBankDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WorldBankDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WorldBankDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WorldBankDataError('boom', 'boom');
        $utility->fetcher = function (WorldBankDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WorldBankDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WorldBankDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WorldBankDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WorldBankDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WorldBankDataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WorldBankDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WorldBankDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WorldBankDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WorldBankDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WorldBankDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WorldBankDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WorldBankDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WorldBankDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WorldBankDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WorldBankDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WorldBankDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WorldBankDataResult(['ok' => false])]);
        $this->expectException(WorldBankDataError::class);
        WorldBankDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WorldBankDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WorldBankDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WorldBankDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WorldBankDataBaseFeature();
        $b = new WorldBankDataBaseFeature();
        WorldBankDataFeatureAdd::call($ctx, $a);
        WorldBankDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WorldBankDataBaseFeature
    {
        $f = new WorldBankDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WorldBankDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WorldBankDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WorldBankDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WorldBankDataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WorldBankDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WorldBankDataResponse(['headers' => null]),
            'result' => new WorldBankDataResult([]),
        ]);
        WorldBankDataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WorldBankDataResultBody::call($ctx);
