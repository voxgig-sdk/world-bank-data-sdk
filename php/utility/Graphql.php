...
// WorldBankData SDK utility: graphql
//
...
class WorldBankDataGraphql
{
    ...
    // equivalent.
    public static function body(WorldBankDataContext $ctx): mixed
    {
    ...
    public static function errors(WorldBankDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
