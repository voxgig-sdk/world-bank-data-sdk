...
class WorldBankDataSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = WorldBankDataHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = WorldBankDataHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!WorldBankDataFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, WorldBankDataFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return WorldBankDataUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = WorldBankDataHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = WorldBankDataHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = WorldBankDataHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new WorldBankDataError($op . "_allow",
                "WorldBankDataSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = WorldBankDataHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new WorldBankDataError("graphql_error",
                "WorldBankDataSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Indicator($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_indicator === null) {
                $this->_indicator = new IndicatorEntity($this, null);
            }
            return $this->_indicator;
        }
        return new IndicatorEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new WorldBankDataSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
