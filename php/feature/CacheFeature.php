...
// WorldBankData SDK cache feature
...
class WorldBankDataCacheFeature extends WorldBankDataBaseFeature
{
    ...
    private function _through(WorldBankDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
