...
// WorldBankData SDK idempotency feature
...
class WorldBankDataIdempotencyFeature extends WorldBankDataBaseFeature
{
    ...
    private function _mutating(WorldBankDataContext $ctx): bool
    {
