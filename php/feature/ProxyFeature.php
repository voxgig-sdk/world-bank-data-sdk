...
// WorldBankData SDK proxy feature
...
class WorldBankDataProxyFeature extends WorldBankDataBaseFeature
{
    ...
    public function init(WorldBankDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WorldBankDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
