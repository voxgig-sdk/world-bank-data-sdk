...
// WorldBankData SDK metrics feature
...
class WorldBankDataMetricsFeature extends WorldBankDataBaseFeature
{
    ...
    private function _record(WorldBankDataContext $ctx, bool $ok): void
    {
