...
// WorldBankData SDK rbac feature
...
class WorldBankDataRbacFeature extends WorldBankDataBaseFeature
{
    ...
    private function _required(WorldBankDataContext $ctx): ?string
    {
    ...
    private function _reject(WorldBankDataContext $ctx, string $required): void
    {
    ...
    private function _track(WorldBankDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
