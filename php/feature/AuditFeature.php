...
// WorldBankData SDK audit feature
...
class WorldBankDataAuditFeature extends WorldBankDataBaseFeature
{
    ...
    private function _emit(WorldBankDataContext $ctx, string $outcome): void
    {
