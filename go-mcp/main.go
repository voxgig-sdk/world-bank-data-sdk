// Command WorldBankData-mcp is an MCP server exposing the WorldBankData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WorldBankData_list  — list records of an entity
//	WorldBankData_load  — load a single record of an entity
//
