...
class TopicEntity extends WorldBankDataEntityBase_1.WorldBankDataEntityBase {
    ...
    make() {
        return new TopicEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Topic[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
