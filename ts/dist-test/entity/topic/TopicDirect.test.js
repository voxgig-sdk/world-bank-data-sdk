...
(0, node_test_1.describe)('TopicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-topic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-topic', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["topic01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.id = setup.idmap['topic01'];
        }
        else {
            params.id = 'direct01';
        }
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'WORLD_BANK_DATA_TEST_TOPIC_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['WORLD_BANK_DATA_TEST_TOPIC_ENTID'];
...
//# sourceMappingURL=TopicDirect.test.js.map