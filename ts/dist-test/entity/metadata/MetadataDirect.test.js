...
(0, node_test_1.describe)('MetadataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-metadata', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-metadata', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["source01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['WORLD_BANK_DATA_TEST_METADATA_ENTID'];
...
//# sourceMappingURL=MetadataDirect.test.js.map