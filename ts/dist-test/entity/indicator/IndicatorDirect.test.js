...
(0, node_test_1.describe)('IndicatorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WorldBankDataSDK({
    ...
    (0, node_test_1.test)('direct-load-indicator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-indicator', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["country_code01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-indicator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-indicator', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.WORLD_BANK_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WorldBankDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WORLD_BANK_DATA_TEST_INDICATOR_ENTID'];
    ...
    const client = new __1.WorldBankDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IndicatorDirect.test.js.map