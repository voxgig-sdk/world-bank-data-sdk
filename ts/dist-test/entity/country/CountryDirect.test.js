...
(0, node_test_1.describe)('CountryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-country', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-country', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-country', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-country', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['WORLD_BANK_DATA_TEST_COUNTRY_ENTID'];
...
//# sourceMappingURL=CountryDirect.test.js.map