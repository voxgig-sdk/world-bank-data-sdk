...
class CountryEntity extends WorldBankDataEntityBase<Country> {
  ...
  make(this: CountryEntity) {
    return new CountryEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CountryLoadMatch, ctrl?: Control): Promise<CountryEntity> {
