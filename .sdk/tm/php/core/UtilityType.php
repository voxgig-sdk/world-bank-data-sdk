...
// WorldBankData SDK utility type

class WorldBankDataUtility
{
    ...
    public static function copy(WorldBankDataUtility $src): WorldBankDataUtility
    {
        $u = new WorldBankDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
