...
// WorldBankData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WorldBankDataMakeRequest
{
    public static function call(WorldBankDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WorldBankDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WorldBankDataResponse($fetched);
        } else {
