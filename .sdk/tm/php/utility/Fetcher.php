...
// WorldBankData SDK utility: fetcher
...
class WorldBankDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WorldBankDataSDK/1.0)';
    ...
    public static function call(WorldBankDataContext $ctx, string $fullurl, array $fetchdef): array
    {
