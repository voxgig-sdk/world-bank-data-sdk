...
// WorldBankData SDK utility: make_options

class WorldBankDataMakeOptions
{
    ...
    public static function call(WorldBankDataContext $ctx): array
    {
        ...
        //
        // `WorldBankDataSchema::optspec()` is built from the model:
        ...
        $optspec = WorldBankDataSchema::optspec();
