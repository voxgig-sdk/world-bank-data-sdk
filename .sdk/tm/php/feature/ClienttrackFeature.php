...
// WorldBankData SDK clienttrack feature
...
class WorldBankDataClienttrackFeature extends WorldBankDataBaseFeature
{
    ...
    public function PostConstruct(WorldBankDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WorldBankData-SDK';
