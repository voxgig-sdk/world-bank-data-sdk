...
// WorldBankData SDK ratelimit feature
...
class WorldBankDataRatelimitFeature extends WorldBankDataBaseFeature
{
    ...
    private function _acquire(WorldBankDataContext $ctx): void
    {
    ...
    private function _track(WorldBankDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
