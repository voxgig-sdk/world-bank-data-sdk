...
// WorldBankData SDK netsim feature
...
class WorldBankDataNetsimFeature extends WorldBankDataBaseFeature
{
    ...
    private function _simulate(WorldBankDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WorldBankDataContext $ctx, array $applied): void
    {
        $client = $this->client;
