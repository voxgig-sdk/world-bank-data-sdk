...
// WorldBankData SDK timeout feature
...
class WorldBankDataTimeoutFeature extends WorldBankDataBaseFeature
{
    ...
    private function _with_timeout(WorldBankDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WorldBankDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
