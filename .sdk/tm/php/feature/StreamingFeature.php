...
// WorldBankData SDK streaming feature
...
class WorldBankDataStreamingFeature extends WorldBankDataBaseFeature
{
    ...
    private function _iterate(WorldBankDataResult $result): \Generator
    {
    ...
    private function _streamable(WorldBankDataContext $ctx): bool
    {
