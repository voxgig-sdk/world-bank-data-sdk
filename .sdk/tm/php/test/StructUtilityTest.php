...
// WorldBankData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WorldBankDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WorldBankDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(WorldBankDataOmni::structfix($val, Struct::undef()))) {
