...
class WorldBankDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldBankDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WorldBankDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WorldBankDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
