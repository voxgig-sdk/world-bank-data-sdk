...
class WorldBankDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WorldBankDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WorldBankDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WorldBankDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
