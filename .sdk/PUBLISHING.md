...
|---|---|---|
| `ts/` | @voxgig-sdk/world-bank-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/world-bank-data-sdk \
      --repository voxgig-sdk/world-bank-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/world-bank-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/world-bank-data-sdk --id=<id>` removes it.
